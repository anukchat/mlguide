...
▶️ [Demo | Logistic Regression With Linear Boundary](../concepts/notebooks/logistic_regression/logistic_regression_with_linear_boundary_demo.ipynb) - predict Iris flower `class` based on `petal_length` and `petal_width`

▶️ [Demo | Logistic Regression With Non-Linear Boundary](../concepts/notebooks/logistic_regression/logistic_regression_with_non_linear_boundary_demo.ipynb) - predict microchip `validity` based on `param_1` and `param_2`

▶️ [Demo | Multivariate Logistic Regression | MNIST](../concepts/notebooks/logistic_regression/multivariate_logistic_regression_demo.ipynb) - recognize handwritten digits from `28x28` pixel images.

▶️ [Demo | Multivariate Logistic Regression | Fashion MNIST](../concepts/notebooks/logistic_regression/multivariate_logistic_regression_fashion_demo.ipynb) - recognize clothes types from `28x28` pixel images.
...
![Logistic Regression Output](/content/concepts/images/logistic_regression/output.svg)
...
![Training Set](/content/concepts/images/logistic_regression/training-set-1.svg)

_m_ - number of training set examples.

![Training Set](/content/concepts/images/logistic_regression/training-set-2.svg)

For convenience of notation, define:

![x-zero](/content/concepts/images/logistic_regression/x-0.svg)
...
![Hypothesis](/content/concepts/images/logistic_regression/hypothesis-1.svg)

Where _g()_ is a **sigmoid function**.

![Sigmoid](/content/concepts/images/logistic_regression/sigmoid.svg)

![Sigmoid](https://upload.wikimedia.org/wikipedia/commons/8/88/Logistic-curve.svg)

Now we my write down the hypothesis as follows:

![Hypothesis](/content/concepts/images/logistic_regression/hypothesis-2.svg)

![Predict 0](/content/concepts/images/logistic_regression/predict-0.svg)

![Predict 1](/content/concepts/images/logistic_regression/predict-1.svg)

## Cost Function

Function that shows how accurate the predictions of the hypothesis are with current set of parameters.

![Cost Function](/content/concepts/images/logistic_regression/cost-function-1.svg)

![Cost Function](/content/concepts/images/logistic_regression/cost-function-4.svg)

![Cost Function](/content/concepts/images/logistic_regression/cost-function-2.svg)

Cost function may be simplified to the following one-liner:

![Cost Function](/content/concepts/images/logistic_regression/cost-function-3.svg)
...
We need to simultaneously update ![Theta](/content/concepts/images/logistic_regression/theta-j.svg) for _j = 0, 1, ..., n_

![Gradient Descent](/content/concepts/images/logistic_regression/gradient-descent-1.svg)

![Gradient Descent](/content/concepts/images/logistic_regression/gradient-descent-2.svg)

![alpha](/content/concepts/images/logistic_regression/alpha.svg) - the learning rate, the constant that defines the size of the gradient descent step

![x-i-j](/content/concepts/images/logistic_regression/x-i-j.svg) - _j<sup>th</sup>_ feature value of the _i<sup>th</sup>_ training example

![x-i](/content/concepts/images/logistic_regression/x-i.svg) - input (features) of _i<sup>th</sup>_ training example
...
To handle these type of issues we may train a logistic regression classifier ![Multi-class classifier](/content/concepts/images/logistic_regression/multi-class-classifier.svg) several times for each class _i_ to predict the probability that _y = i_.
...
![overfitting](/content/concepts/images/logistic_regression/overfitting-1.svg)
...
![Cost Function](/content/concepts/images/logistic_regression/cost-function-with-regularization.svg)

![regularization parameter](/content/concepts/images/logistic_regression/lambda.svg) - regularization parameter

> Note that you should not regularize the parameter ![theta zero](/content/concepts/images/logistic_regression/theta-0.svg).

In this case the **gradient descent** formula will look like the following:

![Gradient Descent](/content/concepts/images/logistic_regression/gradient-descent-3.svg)
