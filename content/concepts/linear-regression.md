...
▶️ [Demo | Univariate Linear Regression](../concepts/notebooks/linear_regression/univariate_linear_regression_demo.ipynb) - predict `country happiness` score by `economy GDP`

▶️ [Demo | Multivariate Linear Regression](../concepts/notebooks/linear_regression/multivariate_linear_regression_demo.ipynb) - predict `country happiness` score by `economy GDP` and `freedom index`

▶️ [Demo | Non-linear Regression](../concepts/notebooks/linear_regression/non_linear_regression_demo.ipynb) - use linear regression with _polynomial_ and _sinusoid_ features to predict non-linear dependencies.
...
![Features](/content/concepts/images/linear_regression/features.svg)
...
![Parameters](/content/concepts/images/linear_regression/parameters.svg)
...
![Hypothesis](/content/concepts/images/linear_regression/hypothesis.svg)
...
![Cost Function](/content/concepts/images/linear_regression/cost-function.svg)
...
We need to simultaneously update ![Theta](/content/concepts/images/linear_regression/theta-j.svg) for _j = 0, 1, ..., n_

![Gradient Descent](/content/concepts/images/linear_regression/gradient-descent-1.svg)

![Gradient Descent](/content/concepts/images/linear_regression/gradient-descent-2.svg)

![alpha](/content/concepts/images/linear_regression/alpha.svg) - the learning rate, the constant that defines the size of the gradient descent step

![x-i-j](/content/concepts/images/linear_regression/x-i-j.svg) - _j<sup>th</sup>_ feature value of the _i<sup>th</sup>_ training example

![x-i](/content/concepts/images/linear_regression/x-i.svg) - input (features) of _i<sup>th</sup>_ training example
...
![Feature Scaling](/content/concepts/images/linear_regression/feature-scaling.svg)
...
![Mean Normalization](/content/concepts/images/linear_regression/mean-normalization.svg)

![x-i-j](/content/concepts/images/linear_regression/x-i-j.svg) - _j<sup>th</sup>_ feature value of the _i<sup>th</sup>_ training example

![mu-j](/content/concepts/images/linear_regression/mu-j.svg) - average value of _j<sup>th</sup>_ feature in training set

![s-j](/content/concepts/images/linear_regression/s-j.svg) - the range (_max - min_) of _j<sup>th</sup>_ feature in training set.
...
![Polynomial Regression](/content/concepts/images/linear_regression/polynomial-regression.svg)

## Normal Equation

There is a closed-form solution to linear regression exists and it looks like the following:

![Normal Equation](/content/concepts/images/linear_regression/normal-equation.svg)
...
![overfitting](/content/concepts/images/linear_regression/overfitting-1.svg)
...
![Cost Function](/content/concepts/images/linear_regression/cost-function-with-regularization.svg)

> Note that you should not regularize the parameter ![theta zero](/content/concepts/images/linear_regression/theta-0.svg).

![regularization parameter](/content/concepts/images/linear_regression/lambda.svg) - regularization parameter

In this case the **gradient descent** formula will look like the following:

![Gradient Descent](/content/concepts/images/linear_regression/gradient-descent-3.svg)
